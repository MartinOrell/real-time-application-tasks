...
class Cell_Capsule: public mrt::Capsule{
    ...
    private:
        ...
        void sendToCellStatusMessage(int toId, bool isAlive);
        void sendNumNeighborsMessage(int toId, int numNeighbors);
        void receiveToggleMessage();
        void receiveTickMessage();
        void receiveStatusMessage(const mrt::CellToCellStatusMessage& message);
